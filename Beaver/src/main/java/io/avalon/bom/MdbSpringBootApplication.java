...
//		groceryItemRepo.save(new Finish("Whole Wheat Biscuit", "Whole Wheat Biscuit", 5, "snacks"));
//		groceryItemRepo.save(new Finish("Kodo Millet", "XYZ Kodo Millet healthy", 2, "millets"));
//		groceryItemRepo.save(new Finish("Dried Red Chilli", "Dried Whole Red Chilli", 2, "spices"));
//		groceryItemRepo.save(new Finish("Pearl Millet", "Healthy Pearl Millet", 1, "millets"));
//		groceryItemRepo.save(new Finish("Cheese Crackers", "Bonny Cheese Crackers Plain", 6, "snacks"));
	...
	// 1. Show all the data
	 ...
	 public void getGroceryItemByName(String name) {
		 ...
		 Finish item = groceryItemRepo.findItemByName(name);
	 ...
	 public void getItemsByCategory(String category) {
		 ...
		 List<Finish> list = groceryItemRepo.findAll(category);
...
//			 item.setCategory(newCategory);
		 ...
		 List<Finish> itemsUpdated = groceryItemRepo.saveAll(list);
	 ...
	 public String getItemDetails(Finish item) {
